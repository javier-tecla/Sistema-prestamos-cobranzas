<x-layouts::app title="Datos del cliente">
    <div class="relative mb-6 w-full">
        <div class="flex items-center justify-between mb-4">
            ...
            <flux:breadcrumbs>
                ...
                <flux:breadcrumbs.item>Datos del cliente: {{ Str::lower($cliente->apellidos.' '. $cliente->nombres) }}</flux:breadcrumbs.item>
            </flux:breadcrumbs>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <section>
                        ...
                        <div
                            ...
                            <p class="text-sm text-blue-700 dark:text-blue-300 font-mono">{{ $cliente->nombres.' '. $cliente->apellidos }}</p>
