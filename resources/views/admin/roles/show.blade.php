    ...
    <div
        ...
        <div class="p-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="mb-4">
                    <flux:field>
                        <flux:label class="flex items-center gap-1">Nombre del rol </flux:label>
                        <p class="text-gray-600"><i class="fas fa-shield-alt mr-2"></i> {{ $rol->name }}</p>
                    </flux:field>
                </div>
                ...
                <div class="mb-4">
                    <flux:field>
                        ...
                        <p class="text-gray-600"><i class="fas fa-clock mr-2"></i>
                            {{ $rol->created_at->format('d/m/Y g:i a') }}</p>
