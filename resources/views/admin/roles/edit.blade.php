    ...
    <div class="relative mb-6 w-full">
        <div class="flex items-center justify-between mb-4">
            ...
            <flux:breadcrumbs>
                ...
                <flux:breadcrumbs.item>Modificar rol: {{ Str::lower($rol->name)  }}</flux:breadcrumbs.item>
            </flux:breadcrumbs>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <flux:field>
                            ...
                            <flux:input name="name" icon="shield-check" value="{{ $rol->name }}" placeholder="Nombre del rol..."
